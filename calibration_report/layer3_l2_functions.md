...
|--------|-------|-----------|--------|
| Spectral Efficiency | 8.152 bps/Hz | [6.0, 12.0] | OK |
...
| Metric | Value | Criterion | Status |
|--------|-------|-----------|--------|
| Spectral Efficiency | 4.674 bps/Hz | [3.0, 7.0] | OK |
...
| Metric | Value | Criterion | Status |
|--------|-------|-----------|--------|
| Spectral Efficiency | 3.384 bps/Hz | [2.0, 5.0] | OK |
| Cell throughput | 338.4 Mbps | — | — |
| Cell edge (5%) | 20.4 Mbps | — | — |
