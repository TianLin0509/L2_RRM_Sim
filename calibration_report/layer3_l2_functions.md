...
|--------|-------|-----------|--------|
| Spectral Efficiency | 8.533 bps/Hz | [6.0, 12.0] | OK |
| Cell throughput | 853.3 Mbps | — | — |
| Cell edge (5%) | 18.7 Mbps | — | — |
| Avg BLER | 0.0000 | [0.05, 0.15] | OUT |
| Avg MCS | 21.4 | — | — |
| Avg Rank | 4.00 | — | — |
| Jain fairness | 0.8637 | — | — |
...
| Metric | Value | Criterion | Status |
|--------|-------|-----------|--------|
| Spectral Efficiency | 4.762 bps/Hz | [3.0, 7.0] | OK |
| Cell throughput | 476.2 Mbps | — | — |
| Cell edge (5%) | 12.3 Mbps | — | — |
| Avg BLER | 0.0000 | [0.05, 0.15] | OUT |
| Avg MCS | 23.8 | — | — |
| Avg Rank | 2.00 | — | — |
| Jain fairness | 0.8987 | — | — |
| PRB utilization | 80.0% | >70% | OK |
| **Overall** | | | **FAIL** |
...
| Metric | Value | Criterion | Status |
|--------|-------|-----------|--------|
| Spectral Efficiency | 3.238 bps/Hz | [2.0, 5.0] | OK |
| Cell throughput | 323.8 Mbps | — | — |
| Cell edge (5%) | 19.5 Mbps | — | — |
